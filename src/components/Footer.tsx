        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-5 space-y-5">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 rounded-none border border-[#B08D57] flex items-center justify-center bg-black">
                <span className="font-display font-light text-xs tracking-wider text-[#F7F5F0]">O</span>
              </div>
              <span className="font-display text-xl tracking-[0.22em] font-semibold text-white">
            ...
            <p className="text-xs text-white/60 max-w-sm leading-relaxed font-light">
              Strategic real-estate advisory, high-value asset evaluation, and project marketing across Hyderabad, Telangana.
            </p>
          ...
          <div className="lg:col-span-3">
            <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#B08D57] block mb-5">
              PLATFORM INDEX
            </span>
            <ul className="space-y-3 text-xs tracking-wider uppercase text-white/70">
              ...
              <li>
                <a href="#expertise" className="hover:text-[#B08D57] transition-colors">
                  Our Expertise
                </a>
              </li>
              <li>
                <a href="#hyderabad-focus" className="hover:text-[#B08D57] transition-colors">
                  Hyderabad Corridors
                </a>
              </li>
              <li>
                <a href="#opportunities" className="hover:text-[#B08D57] transition-colors">
                  Selected Opportunities
                </a>
              </li>
              <li>
                <a href="#insights" className="hover:text-[#B08D57] transition-colors">
                  Market Intelligence
                </a>
              </li>
              <li>
                <a href="#process" className="hover:text-[#B08D57] transition-colors">
                  How We Work
                </a>
              </li>
              <li>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              >
                ...
                <ArrowUp className="w-3.5 h-3.5 text-[#B08D57]" />
              </button>
            </div>
          </div>
        </div>
