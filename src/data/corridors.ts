...
export const GROWTH_CORRIDORS: GrowthCorridor[] = [
  ...
  slug: 'neopolis',
    ...
    infraStatus: [
      { name: 'Layout Internal 45m Arterials', detail: 'Complete & operational', status: 'CONFIRMED' },
      { name: 'ORR Trumpet Interchange', detail: 'Complete & operational', status: 'CONFIRMED' },
      { name: 'Metro Phase 2 Neopolis Spur', detail: 'Approved in principle, financial sanction pending', status: 'UNFUNDED' },
      { name: 'HMWSSB Water Pipeline', detail: 'Trunk line under extension', status: 'UNCERTAIN' }
    ],
  ...
  slug: 'financial-district',
    ...
    infraStatus: [
      { name: 'ORR Junction 19 Underpass', detail: 'Fully operational', status: 'CONFIRMED' },
      { name: 'Financial District Road Widening', detail: 'Work actively under construction', status: 'LIKELY' },
      { name: 'Metro Rail Phase 2 Link', detail: 'Approved alignment, full sanction awaited', status: 'UNFUNDED' },
      { name: 'Multi-Level Car Parking Hub', detail: 'Sanctioned & allocated', status: 'LIKELY' }
    ],
  ...
  slug: 'kokapet',
    ...
    infraStatus: [
      { name: 'ORR Service Road Widening', detail: 'Operational since 2018', status: 'CONFIRMED' },
      { name: 'Golden Mile Arterial Flyover', detail: 'Under active construction', status: 'LIKELY' },
      { name: 'Metro Rail Phase 2 Kokapet Station', detail: 'Detailed project report submitted, unfunded', status: 'UNFUNDED' },
      { name: 'Underground Drainage System', detail: 'HMDA master upgrade under execution', status: 'LIKELY' }
    ],
  ...
  slug: 'hitech-city',
    ...
    infraStatus: [
      { name: 'Metro Blue Line (Raidurg - Nagole)', detail: 'Fully operational', status: 'CONFIRMED' },
      { name: 'Durgam Cheruvu Cable Bridge', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Mindspace Multi-Level Flyovers', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Urban Stormwater Network Upgrade', detail: 'Phased implementation', status: 'LIKELY' }
    ],
  ...
  slug: 'gachibowli',
    ...
    infraStatus: [
      { name: 'Bio-Diversity Junction Flyover', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Old Mumbai Highway Grade Separator', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Metro Phase 2 Gachibowli Spur', detail: 'Approved in DPR, awaits central sanction', status: 'UNFUNDED' },
      { name: 'Gachibowli Stadium Road Expansion', detail: 'Completed', status: 'CONFIRMED' }
    ],
  ...
  slug: 'narsingi',
    ...
    infraStatus: [
      { name: 'ORR Interchange 18', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Puppalguda - Narsingi 100ft Road', detail: 'Partially widened, work in progress', status: 'LIKELY' },
      { name: 'Metro Phase 2 Connection', detail: 'Not included in active priority DPR', status: 'UNFUNDED' },
      { name: 'Musi Riverfront Green Corridor', detail: 'Master planning initiated', status: 'UNCERTAIN' }
    ],
  ...
  slug: 'airport-corridor',
    ...
    infraStatus: [
      { name: 'PVNR Elevated Expressway', detail: 'Operational', status: 'CONFIRMED' },
      { name: 'Airport Express Metro Line', detail: 'Realignment under review by state government', status: 'UNCERTAIN' },
      { name: 'GMR Aviation SEZ Infrastructure', detail: 'Operational and expanding', status: 'CONFIRMED' },
      { name: 'Regional Ring Road (RRR) South', detail: 'Land acquisition in progress', status: 'LIKELY' }
    ],
